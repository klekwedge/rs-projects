...
function createMovieModal(newMovie) {
  ...
  const ratingCountMovie = movieModalTemplate.querySelector('.info__rating-count');
  ...
  languageMovie.textContent = `Original language: ${newMovie.original_language}`;
...
inputNameMovie.addEventListener('keydown', (event) => {
